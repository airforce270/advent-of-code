...
// hilariously bad brute-force solution that involves no skill or intellect whatsoever
// it will 100% your cpu until it finishes
// do not take any learnings from this
            ...
            ln if ln.starts_with("seeds:") => {
                ...
                for seed_num in seed_nums {
                    match current_start {
                        ...
                        None => current_start = Some(seed_num),
                    }
                }
            }
